...
# Основная цель
.PHONY: setup
setup: check-deps setup-name setup-icon setup-notifications setup-bundle-id setup-podfile setup-privacy setup-capabilities setup-notifications-frameworks
